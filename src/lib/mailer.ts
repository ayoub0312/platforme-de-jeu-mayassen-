  ...
  <tr>
    <td align="center">
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px; width:100%; background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #eceff1;">
        <tr>
          <td style="background:#FF8C00; padding:28px 32px; text-align:center;">
            <div style="font-size:32px; line-height:1;">🏆</div>
            <div style="color:#ffffff; font-weight:800; font-size:20px; margin-top:8px;">Félicitations !</div>
          </td>
        </tr>
        <tr>
          <td style="padding:28px 32px 8px 32px; color:#1a1a1a; font-size:14px;">
        ...
        <tr>
          <td style="padding:0 32px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FFF7ED; border:1px solid #FFE3BF; border-radius:12px;">
              <tr>
                <td style="padding:16px 20px; text-align:center; font-weight:800; font-size:15px; color:#1a1a1a;">
                  🎁 ${prizeName}
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td style="padding:24px 32px 8px 32px; text-align:center;">
            ...
            <p style="margin:4px 0 0 0; font-size:13px; font-weight:700; letter-spacing:0.5px; color:#1a1a1a;">${confirmationCode}</p>
          </td>
        </tr>
        <tr>
          <td style="padding:8px 32px 8px 32px; text-align:center;">
            <a href="${voucherUrl}" style="display:inline-block; background:#FF8C00; color:#ffffff; text-decoration:none; font-weight:700; font-size:13px; padding:12px 24px; border-radius:10px;">
