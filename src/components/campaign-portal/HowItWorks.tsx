  ...
  return (
    <div className="w-full max-w-7xl mt-16 bg-white border-none rounded-3xl p-8 shadow-sm">
      <h3 className="text-center font-black text-slate-850 text-sm mb-8 flex items-center justify-center gap-1.5">
        <Info className="h-4 w-4 text-[#FF6B47]" /> Comment fonctionne la roulette ?
      </h3>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 relative">
        <div className="flex flex-col items-center text-center px-4">
          <div className="h-10 w-10 rounded-full bg-orange-100 text-[#FF6B47] font-black text-sm flex items-center justify-center mb-4 shadow-sm">1</div>
        ...
        <div className="flex flex-col items-center text-center px-4">
          <div className="h-10 w-10 rounded-full bg-orange-100 text-[#FF6B47] font-black text-sm flex items-center justify-center mb-4 shadow-sm">2</div>
        ...
        <div className="flex flex-col items-center text-center px-4">
          <div className="h-10 w-10 rounded-full bg-orange-100 text-[#FF6B47] font-black text-sm flex items-center justify-center mb-4 shadow-sm">3</div>
